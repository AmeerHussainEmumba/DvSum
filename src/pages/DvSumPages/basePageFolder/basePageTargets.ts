export let baseUrl='https://devqa.dvsum.com/login';
export let username='testautomation@dvsum.com'; 
export let password='1@Qwerty';
export let emailfield= '//div[contains(@class, "visible-md")]//input[@id="signInFormUsername"]';
